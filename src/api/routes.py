...
from api.favoritepeople import FavoritePeople
from api.favoriteplanets import FavoritePlanets
from api.favoritevehicles import FavoriteVehicles
...
@api.route('/get-planets/<int:id>', methods=['GET'])
...
@api.route('/post-planets', methods=['POST'])
...
@api.route('/delete-planets', methods=['DELETE'])
...
@api.route('/put-planet', methods=['PUT'])
def edit_Planets():
    body = request.get_json()   
    id = body["id"]
    name = body["name"]
...
@api.route('/favoritePlanets', methods=['POST'])
...
@api.route('/removefavoriteplanet', methods=['DELETE'])
...
@api.route('/get-vehicles/<int:id>', methods=['GET'])
...
@api.route('/post-vehicles', methods=['POST'])
...
@api.route('/delete-vehicles', methods=['DELETE'])
...
@api.route('/put-vehicles', methods=['PUT'])
def edit_Vehicles():
    body = request.get_json()   
    id = body["id"]
    name = body["name"]
...
@api.route('/favoriteVehicles', methods=['POST'])
...
@api.route('/remove-favorite/vehicle', methods=['DELETE'])
